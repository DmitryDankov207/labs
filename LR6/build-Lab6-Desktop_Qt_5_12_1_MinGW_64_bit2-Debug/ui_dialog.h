...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        pushButton_swap = new QPushButton(Dialog);
        pushButton_swap->setObjectName(QString::fromUtf8("pushButton_swap"));
        sizePolicy.setHeightForWidth(pushButton_swap->sizePolicy().hasHeightForWidth());
        pushButton_swap->setSizePolicy(sizePolicy);

        verticalLayout_3->addWidget(pushButton_swap);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        pushButton_swap->setText(QApplication::translate("Dialog", "Swap", nullptr));
    } // retranslateUi
